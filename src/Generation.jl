...
"""
    function build_full_query(query::String, context::Union{Vector{String}, Nothing}=nothing)
...
context : Union{Vector{String}, Nothing}
...
"""
    generate(generator::Union{OAIGenerator, Nothing}, query::String, context::Union{Vector{String}, Nothing}=nothing, temperature::Float64=0.7)
...
"""
function generate(generator::Union{OAIGenerator, Nothing}, query::String, context::Union{Vector{String}, Nothing}=nothing, temperature::Float64=0.7)
